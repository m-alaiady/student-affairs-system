...
<html>
<head>
    <title>SIS | Registration Assistant</title>
...
<body>
    <form method="post">
        <div class="student_data">
            <p class="super-box-title">Registration Assistant</p>
            <div class="row">
                <table>
                    <tr>
                        <th>Details</th>
...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO `registration_assistant` (details, student_id) VALUES ('$details', '$std_id')";  
